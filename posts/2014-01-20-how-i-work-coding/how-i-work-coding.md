...
description: "A look into the tools and tricks I use to get work done."
---
...
When I'm really in the zone and familiar with the codebase, I'll hide the sidebar altogether and work with just the currently open file. Using Sublime's _awesome_ `Goto Anything...` feature you can easily hop between files in the codebase if you're familiar enough. I like doing this as it's faster than searching through the sidebar manually.
